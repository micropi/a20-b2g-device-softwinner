...
DEVICE_PACKAGE_OVERLAYS := device/softwinner/sugar-cubietruck/overlay

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-cubietruck/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/sugar-cubietruck/modules/modules/sun7i-ir.ko:root/sun7i-ir.ko \
	#device/softwinner/sugar-cubietruck/modules/modules/disp.ko:root/disp.ko \
	#device/softwinner/sugar-cubietruck/modules/modules/lcd.ko:root/lcd.ko \
	#device/softwinner/sugar-cubietruck/modules/modules/hdmi.ko:root/hdmi.ko \

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-cubietruck/kernel:kernel \
	device/softwinner/sugar-cubietruck/recovery.fstab:recovery.fstab \
...
PRODUCT_COPY_FILES += \
	...
	device/softwinner/sugar-cubietruck/init/init.sdb.rc:root/init.sdb.rc \
	device/softwinner/sugar-cubietruck/init/init.sdc.rc:root/init.sdc.rc \
	device/softwinner/sugar-cubietruck/init/init.sdd.rc:root/init.sdd.rc \
	device/softwinner/sugar-cubietruck/init/init.sde.rc:root/init.sde.rc \
	device/softwinner/sugar-cubietruck/init.recovery.sun7i.rc:root/init.recovery.sun7i.rc \
	device/softwinner/sugar-cubietruck/needfix.rle:root/needfix.rle \
	device/softwinner/sugar-cubietruck/camera.cfg:system/etc/camera.cfg \
	device/softwinner/sugar-cubietruck/media_profiles.xml:system/etc/media_profiles.xml \
	frameworks/native/data/etc/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

#input device config
PRODUCT_COPY_FILES += \
	device/softwinner/sugar-cubietruck/sw-keyboard.kl:system/usr/keylayout/sw-keyboard.kl \
	device/softwinner/sugar-cubietruck/sun7i-ir.kl:system/usr/keylayout/sun7i-ir.kl \
	device/softwinner/sugar-cubietruck/tp.idc:system/usr/idc/tp.idc \
	device/softwinner/sugar-cubietruck/gsensor.cfg:system/usr/gsensor.cfg

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-cubietruck/initlogo.rle:root/initlogo.rle

PRODUCT_COPY_FILES += \
	device/softwinner/sugar-cubietruck/vold.fstab:system/etc/vold.fstab
...
$(call inherit-product-if-exists, device/softwinner/sugar-cubietruck/modules/modules.mk)

PRODUCT_CHARACTERISTICS := manu

# Overrides
PRODUCT_BRAND  := cubie
PRODUCT_NAME   := sugar_cubietruck
PRODUCT_DEVICE := sugar-cubietruck
